...
abstract class Controller
{
    ...
    public function checkAcl()
    {
        ...
        if ($this->isAcl('all')) {
            return true;
        } elseif (isset($_SESSIN['authorize']['id']) and $this->isAcl('authorize')) {
            return true;
        } elseif (!isset($_SESSIN['guest']['id']) and $this->isAcl('guest')) {
            return true;
        } elseif (isset($_SESSIN['admin']['id']) and $this->isAcl('admin')) {
            return true;
        }
        return false;
    }
